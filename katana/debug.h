...
#define DEBUG(Message_) DebugOut::Instance() << __FILE__ << ":" << __LINE__ << " (" << __FUNCTION__ << ") " << Message_
#define DPRINTF(format, ...) DebugOut::Instance().printf(__FILE__, __LINE__, __FUNCTION__, format, ##__VA_ARGS__)
#endif
